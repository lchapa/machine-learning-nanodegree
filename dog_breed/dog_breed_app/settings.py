...
# Posible values: ['VGG16', 'VGG19','InceptionV3', 'Resnet50', 'Xception']
PRETRAINED_MODEL = 'Xception'
MODEL_TOP_LAYER = 'saved_model/best.top.layer.hdf5'
CLASSIFIER_CASCADE = 'haarcascades/haarcascade_frontalface_alt.xml'
